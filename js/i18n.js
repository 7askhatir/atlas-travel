...
(function () {
  ...
  const dict = {
    ...
    'flowcta.btn': { en: 'Start Booking', fr: 'Réserver' },
    ...
    'vehicle.economy.name': { en: 'SUV / 4x4', fr: 'SUV / 4x4' },
    'vehicle.economy.class': { en: 'Premium Comfort', fr: 'Confort Premium' },
    'vehicle.economy.desc': { en: 'Spacious, comfortable, and perfect for airport transfers, long-distance journeys, and excursions across Morocco. Ideal for travelers seeking extra comfort and luggage space.', fr: 'Spacieux, confortable, et parfait pour les transferts aéroport, les longs trajets et les excursions à travers le Maroc. Idéal pour les voyageurs recherchant un confort supplémentaire et un espace bagages généreux.' },
    'vehicle.economy.features': { en: '1–4 Passengers • 4 Bags • Air Conditioning • Comfortable Interior', fr: '1–4 pers • 4 bagages • Climatisation • Intérieur Confortable' },
    'vehicle.premium.badge': { en: '⭐ Most Popular', fr: '⭐ Le Plus Populaire' },
    'vehicle.premium.name': { en: 'Premium Minivan', fr: 'Minivan Premium' },
    'vehicle.premium.class': { en: 'Family & Small Groups', fr: 'Famille & Petits Groupes' },
    'vehicle.premium.desc': { en: 'Spacious and comfortable vehicle, ideal for families and small groups. Offers generous luggage space and a smooth travel experience for airport transfers and long-distance journeys.', fr: 'Véhicule spacieux et confortable, idéal pour les familles et les petits groupes. Offre un espace bagages généreux et une expérience de voyage agréable pour les transferts aéroport et les longs trajets.' },
    'vehicle.premium.features': { en: '1–7 Passengers • 6 Bags • Air Conditioning • Comfortable Interior', fr: '1–7 pers • 6 bagages • Climatisation • Intérieur Confortable' },
    'vehicle.suv.name': { en: 'Executive Sedan', fr: 'Berline Executive' },
    'vehicle.suv.class': { en: 'Business Class', fr: 'Classe Affaires' },
    'vehicle.suv.desc': { en: 'Elegant, comfortable, and ideal for airport transfers, business travel, and private journeys. A premium choice for travelers seeking comfort and style.', fr: 'Élégante, confortable et idéale pour les transferts aéroport, les voyages d\'affaires et les trajets privés. Un choix premium pour les voyageurs recherchant confort et style.' },
    'vehicle.suv.features': { en: '1–3 Passengers • 4 Bags • Air Conditioning • Comfortable Interior', fr: '1–3 pers • 4 bagages • Climatisation • Intérieur Confortable' },
    'vehicle.minivan.badge': { en: 'Group', fr: 'Groupe' },
    'vehicle.minivan.name': { en: 'Group Minibus', fr: 'Minibus Groupe' },
    'vehicle.minivan.class': { en: 'Large Groups & Tours', fr: 'Grands Groupes & Circuits' },
    'vehicle.minivan.desc': { en: 'Perfect for large groups, private tours, airport transfers, and excursions across Morocco. Spacious, comfortable, and designed for group travel with ample luggage capacity.', fr: 'Parfait pour les grands groupes, les circuits privés, les transferts aéroport et les excursions à travers le Maroc. Spacieux, confortable et conçu pour les voyages en groupe avec une grande capacité de bagages.' },
    'vehicle.minivan.features': { en: '1–14 Passengers • 6 Bags • Air Conditioning • Comfortable Interior', fr: '1–14 pers • 6 bagages • Climatisation • Intérieur Confortable' },
    ...
    'flow.vehicle.standard': { en: 'SUV / 4x4', fr: 'SUV / 4x4' },
    'flow.vehicle.suv': { en: 'Executive Sedan', fr: 'Berline Executive' },
    'flow.vehicle.minivan': { en: 'Group Minibus', fr: 'Minibus Groupe' },
    ...
    'footer.contact.email': { en: 'Taxi.tours.essaouira@gmail.com', fr: 'Taxi.tours.essaouira@gmail.com' },
    'footer.contact.address': { en: 'Essaouira, Morocco', fr: 'Essaouira, Maroc' },
    ...
    'booknow.hero.title': { en: 'Book Your <span>Private Transfer</span> in Morocco', fr: 'Réservez Votre <span>Transfert Privé</span> au Maroc' },
    ...
    'booknow.trust.card4.desc': { en: 'All vehicles equipped with A/C for a comfortable journey.', fr: 'Tous les véhicules sont équipés de la climatisation pour un voyage confortable.' },
    'booknow.trust.card5.title': { en: 'Free Child Seats', fr: 'Sièges Enfants Gratuits' },
    'booknow.trust.card5.desc': { en: 'Available on request at no extra charge. All types from infant to booster.', fr: 'Disponibles sur demande sans frais supplémentaires. Tous les types, du nourrisson au rehausseur.' },
    'booknow.routes.label': { en: 'Popular Transfers', fr: 'Transferts Populaires' },
    'booknow.routes.title': { en: 'Most Booked Routes', fr: 'Itinéraires les Plus Réservés' },
    'booknow.routes.subtitle': { en: 'Fixed prices per vehicle — no hidden fees, no surprises.', fr: 'Prix fixes par véhicule — pas de frais cachés, pas de surprises.' },
    'booknow.routes.pervehicle': { en: 'Per vehicle', fr: 'Par véhicule' },
    'booknow.cta.title': { en: 'Ready to Book Your Transfer?', fr: 'Prêt à Réserver Votre Transfert ?' },
    'booknow.cta.text': { en: 'Get an instant price quote and confirmation via WhatsApp in under 2 minutes.', fr: 'Obtenez un devis instantané et une confirmation via WhatsApp en moins de 2 minutes.' },
    'booknow.cta.btn': { en: 'Book Now', fr: 'Réserver' },
    'booknow.footer.desc': { en: 'Your Morocco, Perfectly Planned. Private transfers across Morocco since 2018.', fr: 'Votre Maroc, Parfaitement Planifié. Transferts privés à travers le Maroc depuis 2018.' },
